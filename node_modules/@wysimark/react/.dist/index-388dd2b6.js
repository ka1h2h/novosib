...
var remarkDisableTokenizers = require('remark-disable-tokenizers');
var remarkInlineLinks = require('remark-inline-links');
var remarkParse = require('remark-parse');
var remarkSubSuper = require('remark-sub-super');
...
var assertType = require('@thesunny/assert-type');
var shallowEqual = require('shallowequal');
var axios = require('axios');
var prettyBytes = require('pretty-bytes');
var extraScopePlugin = require('stylis-plugin-extra-scope');
var createCache = require('@emotion/cache');
var resource = require('@wysimark/resource');

function _interopDefaultLegacy (e) { return e && typeof e === 'object' && 'default' in e ? e : { 'default': e }; }

var React__default = /*#__PURE__*/_interopDefaultLegacy(React);
var ReactDOM__default = /*#__PURE__*/_interopDefaultLegacy(ReactDOM);
var moveImagesToRoot__default = /*#__PURE__*/_interopDefaultLegacy(moveImagesToRoot);
var remarkDisableTokenizers__default = /*#__PURE__*/_interopDefaultLegacy(remarkDisableTokenizers);
var remarkInlineLinks__default = /*#__PURE__*/_interopDefaultLegacy(remarkInlineLinks);
var remarkParse__default = /*#__PURE__*/_interopDefaultLegacy(remarkParse);
var remarkSubSuper__default = /*#__PURE__*/_interopDefaultLegacy(remarkSubSuper);
...
var extraScopePlugin__default = /*#__PURE__*/_interopDefaultLegacy(extraScopePlugin);
...
function defineElementType() {
    ...
    _test // IMPORTANT: required for type checking
        ...
        return [
            list,
            function check(node) {
                return slate.Element.isElement(node) && list.includes(node.type);
            },
        ];
    };
}
...
assertType.AssertType.Equal(true);
/**
 * Flush Block Types
 */
...
const parser = unified__default["default"]()
    .use(remarkParse__default["default"])
    .use(remarkSubSuper__default["default"])
    .use(remarkDisableTokenizers__default["default"], { inline: ["url"] });
/**
...
function parseAst(markdown) {
     ...
     */
    remarkInlineLinks__default["default"]()(ast);
    /**
     * Must be after `remarkInlineLinks` because inline links creates images
     */
    moveImagesToRoot__default["default"]()(ast);
    return ast.children;
}
...
const ModalsContext = React__default["default"].createContext(null);
const InModalContext = React__default["default"].createContext(null);
/**
...
function ModalComponent({ data, index }) {
    ...
    return (React__default["default"].createElement(Portal, null,
        React__default["default"].createElement(InModalContext.Provider, { value: value },
            React__default["default"].createElement(Component, Object.assign({}, props)))));
}
function ModalProvider({ children }) {
    const [modals, setModals] = React.useState([]);
    return (React__default["default"].createElement(ModalsContext.Provider, { value: { modals, setModals } },
        children,
        modals.map((data, index) => (React__default["default"].createElement(ModalComponent, { key: index, index: index, data: data })))));
}
/**
...
function useModal(modalType) {
    ...
    function open(Component, props) {
        ...
        if (modalData != null &&
            ...
            shallowEqual__default["default"](modalData.props, props)) {
            return;
        }
        /**
         * Set Modal
 ...
 */
function useInModal() {
    const context = React.useContext(InModalContext);
    if (context == null)
...
const cache = createCache__default["default"]({
    stylisPlugins: [extraScopePlugin__default["default"](".wm-reset-1.wm-reset-2.wm-reset-3")],
});
function Reset({ children }) {
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        React__default["default"].createElement(core.Global, { styles: resetCss }),
        React__default["default"].createElement(core.CacheProvider, { value: cache },
            React__default["default"].createElement("div", { className: "wm-reset-1 wm-reset-2 wm-reset-3" }, children))));
}
function ResetContainer({ children }) {
    return React__default["default"].createElement("div", { className: "wm-reset-1 wm-reset-2 wm-reset-3" }, children);
}
...
function blockquote(editor) {
    slate.Transforms.wrapNodes(editor, { type: "blockquote", children: [] }, {
...
function unblockquote(editor) {
    slate.Transforms.unwrapNodes(editor, {
        match: (node) => slate.Element.isElement(node) && node.type === "blockquote",
    });
}
...
function getNodeEntries(editor, match) {
    return Array.from(slate.Editor.nodes(editor, { match }));
}
/**
...
function setConvertibleElement(editor, getConvertibleElementProps, at) {
    ...
    const matches = slate.Editor.nodes(editor, {
        at,
    ...
    for (const [node, pos] of matches) {
        ...
        slate.Transforms.setNodes(editor, convertibleElementProps, { at: pos });
        ...
        slate.Transforms.unsetNodes(editor, propKeysToRemove, { at: pos });
    }
}
...
function toggleHeading(editor, level) {
    ...
    const isAllSameHeadingLevel = textBlockPairs.every(([block]) => slate.Element.isElement(block) &&
        block.type == "heading" &&
        block.level === level);
...
function reselect(editor) {
    ...
    function getDefaultRange() {
        const defaultPoint = slate.Editor.start(editor, [0]);
        return {
            anchor: defaultPoint,
            focus: defaultPoint,
        };
    ...
    slate.Transforms.select(editor, (_a = editor.lastSelection) !== null && _a !== void 0 ? _a : getDefaultRange());
}
...
function selectAfter(editor, afterPath) {
     ...
     */
    const nextNodeEntry = slate.Editor.next(editor, { at: afterPath });
...
function insertAndSelectInBlock(editor, srcNode) {
    ...
    const destNodeEntry = slate.Editor.above(editor, {
        at: destPoint,
        match: isPrimaryBlockElement,
        mode: "lowest",
    });
    ...
    if (isConvertible) {
         ...
         */
        const isAtStart = slate.Editor.isStart(editor, destPoint, destPath);
        const isEmpty = slate.Node.string(destNode) === "";
        /**
         * Insert the node
         */
        slate.Transforms.insertNodes(editor, srcNode);
        /**
         ...
         */
        if (isEmpty) {
            slate.Transforms.delete(editor, { at: destPath });
     ...
     */
    const insertPath = slate.Path.next(destPath);
    slate.Transforms.insertNodes(editor, srcNode, { at: insertPath });
    return selectAfter(editor, destPath);
}
...
function insertVoidBlock(editor, srcNode) {
     ...
     * what we do.
     */
    const nextPath = slate.Path.next(insertPath);
    const hasNext = slate.Node.has(editor, nextPath);
    if (hasNext) {
        const nextNode = slate.Node.get(editor, nextPath);
     ...
     */
    slate.Transforms.insertNodes(editor, { type: "p", children: [{ text: "" }] }, { at: nextPath });
    /**
...
function insertParagraphAt(editor, path) {
    slate.Transforms.insertNodes(editor, { type: "p", children: [{ text: "" }] }, { at: path });
...
function getStartRange(editor) {
    return {
        anchor: slate.Editor.start(editor, [0]),
        focus: slate.Editor.start(editor, [0]),
    };
}
/**
...
function getLinkInfo(editor) {
    try {
        ...
        if (linkEntry == null) {
             ...
             */
            const fragment = slate.Node.fragment(editor, editor.lastSelection);
            const text = fragment.map(slate.Node.string).join("");
             ...
             */
            return {
                text: slate.Node.string(linkEntry[0]),
                url: linkEntry[0].url,
                path: linkEntry[1],
                range: {
                    anchor: slate.Editor.start(editor, linkEntry[1]),
                    focus: slate.Editor.end(editor, linkEntry[1]),
                },
            };
        }
        // }
...
function tabInList(editor, delta) {
    ...
    for (const [node, pos] of liEntries) {
        ...
        slate.Transforms.setNodes(editor, { depth: nextDepth }, { at: pos });
    }
}
...
function isSelectedConvertibleTypesAllMatch(editor, convertibleType) {
    if (editor.selection == null)
        return false;
    const matches = Array.from(slate.Editor.nodes(editor, {
        at: editor.selection,
        match: isConvertibleBlockElement,
    }));
...
function toggleMark(editor, mark, markValue = true) {
    ...
    if (isActive) {
        ...
        slate.Editor.addMark(editor, mark, markValue);
    }
}
/**
 * remove all marks
...
function getNodeIf(root, path) {
    ...
    for (let i = 0; i < path.length; i++) {
        const p = path[i];
        if (slate.Text.isText(node) || !node.children[p]) {
            return undefined;
        }
...
function getNodeBeforeIf(root, path) {
    if (path[path.length - 1] <= 0)
        return undefined;
    return getNodeIf(root, slate.Path.previous(path));
}
function getNodeAfterIf(root, path) {
    return getNodeIf(root, slate.Path.next(path));
}
...
function useInitial(showInitial = true) {
    const [initial, setInitial] = React.useState(showInitial);
    React.useEffect(() => {
        /**
...
styled__default["default"].div `
  ...
  max-width: 320px;
`;
styled__default["default"].iframe `
  position: absolute;
  top: 0;
  width: 100%;
  height: 100%;
...
function onPaste(e, editor) {
    ...
    if (files.length > 0) {
        ...
        if (!isUrl__default["default"](text))
            return false;
        stopEvent(e);
...
function isHotkeyPlus(hotkey) {
    ...
    return isHotkey__default["default"](modifiedHotkey);
}
...
function isFocusInside(editor, type) {
    ...
    const above = slate.Editor.above(editor, {
        ...
        match: (n) => {
            return slate.Element.isElement(n) && n.type === type;
        },
    });
    return !!above;
}
...
function getTableInfo(editor, at = editor.selection) {
    ...
    const start = slate.Editor.start(editor, at);
...
function tabForward(editor) {
    ...
    slate.Transforms.select(editor, slate.Editor.start(editor, [...tablePath, nextTrIndex, nextTdIndex]));
}
/**
...
function delayedUpReposition(editor) {
    ...
    setTimeout(() => {
        ...
        if (aboveTrIndex < 0) {
             ...
             */
            const beforePoint = slate.Editor.before(editor, beforeTable.tablePath);
            /**
             ...
             */
            if (beforePoint == null) {
                slate.Transforms.select(editor, slate.Editor.start(editor, beforeTable.tdPath));
            }
            else {
...
function delayedDownReposition(editor) {
    ...
    setTimeout(() => {
        ...
        if (belowTrIndex >= beforeTable.trCount) {
             ...
             */
            const belowPoint = slate.Editor.after(editor, beforeTable.tablePath);
            /**
            ...
            if (belowPoint == null)
                return;
            slate.Transforms.select(editor, belowPoint);
            return;
        }
        /**
        ...
        trs.forEach((tr, trIndex) => {
            tr.children.forEach((td, tdIndex) => {
                if (tdIndex !== td.index) {
                    ...
                    slate.Transforms.setNodes(editor, { index: tdIndex }, { at: tdPath });
                }
            });
        });
    });
...
function insertColumn(editor, offset) {
    slate.Editor.withoutNormalizing(editor, () => {
        ...
        slate.Transforms.setNodes(editor, { columns }, { at: tablePath });
        ...
        table.children.forEach((tr, trIndex) => {
            ...
            slate.Transforms.insertNodes(editor, createTd(tdIndex), { at });
        });
        reindexTable(editor);
    });
}
...
function insertRow(editor, offset) {
    ...
    slate.Transforms.insertNodes(editor, trToInsert, { at });
}
/**
 * Remove table
 */
...
function removeRow(editor) {
    ...
    slate.Editor.withoutNormalizing(editor, () => {
        slate.Transforms.removeNodes(editor, { at: trPath });
        slate.Transforms.select(editor, slate.Editor.start(editor, [
            ...tablePath,
...
function removeColumn(editor) {
    ...
    slate.Editor.withoutNormalizing(editor, () => {
        ...
        slate.Transforms.setNodes(editor, { columns }, { at: tablePath });
        trs.forEach((tr, trIndex) => {
            slate.Transforms.removeNodes(editor, { at: [...tablePath, trIndex, tdIndex] });
        });
        reindexTable(editor);
        const selection = slate.Editor.start(editor, [
            ...tablePath,
            trIndex,
...
function shouldIgnoreBackspace(editor) {
    return shouldIgnoreRemove(editor, slate.Editor.isStart);
}
/**
 * Handle forward delete
 */
function shouldIgnoreDelete(editor) {
    return shouldIgnoreRemove(editor, slate.Editor.isEnd);
}
/**
...
function shouldIgnoreRemoveGlobal(editor) {
    ...
    const anchorMatch = slate.Editor.above(editor, {
        at: anchor,
        match: (n) => slate.Element.isElement(n) && n.type === "td",
    });
    const focusMatch = slate.Editor.above(editor, {
        at: focus,
        match: (n) => slate.Element.isElement(n) && n.type === "td",
    });
    /**
...
const isEnter$3 = isHotkey__default["default"]("enter");
...
function handleKeyDownEnterAutocomplete(event, editor) {
    ...
    const beforeText = slate.Editor.string(editor, range);
    for (const { regexp, createBlockFn, pathTail } of completions) {
        ...
        if (matchData) {
            ...
            slate.Transforms.insertNodes(editor, blockToInsert, { at: path });
            if (!isVoid) {
                ...
                slate.Transforms.insertNodes(editor, { type: "p", children: [{ text: "" }] }, { at: nextBlockPath });
...
const isEnter$2 = isHotkey__default["default"]("enter");
const isShiftEnter = isHotkey__default["default"]("shift+enter");
function handleKeyDownEnterVoid(event, editor) {
    ...
    if (editor.selection == null)
        return false;
    const aboveEntry = slate.Editor.above(editor, {
        at: editor.selection.focus,
        match: (n) => {
    ...
    if (aboveEntry) {
         ...
         */
        const nextPath = shiftEnter ? path : slate.Path.next(path);
...
const isTab = isHotkey__default["default"]("tab");
const isShiftTab = isHotkey__default["default"]("shift+tab");
/**
...
function canOutdent(codeLines) {
    ...
    for (const [node] of codeLines) {
        const leadingSpaces = countLeadingSpaces(slate.Node.string(node));
        if (leadingSpaces < 2)
            return false;
    }
    return true;
...
const isSpace = isHotkey__default["default"]("space");
...
function handleKeyDownSpaceAutocomplete(event, editor) {
    ...
    slate.Transforms.delete(editor);
    slate.Transforms.select(editor, start);
    /**
     * We know the return type will be an Element
     */
    const [[node, pos]] = slate.Editor.nodes(editor, {
        match: (n) => slate.Editor.isBlock(editor, n),
    });
    /**
    ...
    slate.Transforms.setNodes(editor, nextProps, { at: pos });
    return true;
}
...
const isUp = isHotkey__default["default"]("up");
/**
...
function handleKeyDownUp(event, editor) {
    ...
    if (slate.Range.isExpanded(selection))
        return false;
    const isStart = slate.Editor.isStart(editor, selection.anchor, [0]);
    if (!isStart)
        return false;
    if (!isSeamlessElement(slate.Node.get(editor, [0])))
        return false;
...
const $SeamlessContainer = styled__default["default"].div `
  position: relative;
`;
const $InsertLine = styled__default["default"].div `
  position: absolute;
  left: 0;
  right: 0;
  height: 1px;
...
`;
const $InsertButton = styled__default["default"].div `
  cursor: pointer;
  position: absolute;
  width: 24px;
  height: 18px;
...
function SeamlessContainer({ attributes, children, element, }) {
    ...
    const showInsertBefore = React.useMemo(() => {
    ...
    const showInsertAfter = React.useMemo(() => {
        if (!highlighted && !isHover)
            return false;
        const path = slateReact.ReactEditor.findPath(editor, element);
    ...
    const insertPrevious = React.useCallback((e) => {
        stopEvent(e);
        const path = slateReact.ReactEditor.findPath(editor, element);
        insertParagraphAt(editor, path);
    }, [editor, element]);
    const insertNext = React.useCallback((e) => {
        stopEvent(e);
        const path = slateReact.ReactEditor.findPath(editor, element);
        insertParagraphAt(editor, slate.Path.next(path));
    }, [editor, element]);
    return (React__default["default"].createElement($SeamlessContainer, Object.assign({}, attributes, { onMouseEnter: onMouseEnter, onMouseLeave: onMouseLeave }),
        children,
        showInsertBefore && (React__default["default"].createElement(Insert, { className: "--previous", onMouseDown: insertPrevious })),
        showInsertAfter && (React__default["default"].createElement(Insert, { className: "--next", onMouseDown: insertNext }))));
}
function Insert({ className, onMouseDown, }) {
    const { isHover, onMouseEnter, onMouseLeave } = useHover();
    const calculatedClassName = cx__default["default"](className, {
        "--hover": isHover,
    });
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        React__default["default"].createElement($InsertLine, { contentEditable: false, className: calculatedClassName }),
        React__default["default"].createElement($InsertButton, { contentEditable: false, className: calculatedClassName, onMouseDown: onMouseDown, onMouseEnter: onMouseEnter, onMouseLeave: onMouseLeave }, "\u23CE")));
}
...
function BlockQuote({ attributes, children, element, }) {
    return (React__default["default"].createElement(SeamlessContainer, { attributes: attributes, element: element },
        React__default["default"].createElement("blockquote", null, children)));
}
...
function CodeBlock({ attributes, element, children, }) {
    return (React__default["default"].createElement(SeamlessContainer, { attributes: attributes, element: element },
        React__default["default"].createElement("div", { style: { padding: "0.5em 0" } },
            React__default["default"].createElement("pre", null,
                React__default["default"].createElement("code", { spellCheck: false }, children)))));
}
/**
 * Codeline
 */
function CodeLine({ attributes, children, }) {
    return (React__default["default"].createElement("div", Object.assign({}, attributes, { spellCheck: false }), children));
}
...
function HorizontalRule({ attributes, children, element, }) {
    ...
    const focused = slateReact.useFocused();
    const highlighted = selected && focused;
    const containerClassName = cx__default["default"]({ "--highlighted": highlighted });
    /**
    ...
    return (React__default["default"].createElement(SeamlessContainer, { attributes: attributes, element: element },
        children,
        React__default["default"].createElement($OuterContainer$1, { contentEditable: false, draggable: true },
            React__default["default"].createElement($HorizontalRuleContainer, { className: containerClassName },
                React__default["default"].createElement("hr", null)))));
}
const $HorizontalRuleContainer = styled__default["default"].div `
  padding: 1em 0;
  img {
    width: 100%;
    height: 50px;
...
`;
const $OuterContainer$1 = styled__default["default"].div `
  padding-top: 8px;
  padding-bottom: 8px;
  position: relative;
`;

const unselectable = core.css `
  user-select: none;
...
const Mask$1 = styled__default["default"].div `
  position: fixed;
  top: 0;
  bottom: 0;
  left: 0;
...
`;
styled__default["default"](Mask$1) `
...
const $OuterContainer = styled__default["default"].div `
  padding: 1em 0;
  position: relative;
`;
const $TightContainer = styled__default["default"].div `
  position: relative;
...
`;
const $Size = styled__default["default"].div `
  position: absolute;
  bottom: 4px;
  &.--small {
    bottom: -24px;
  ...
  ${unselectable}
`;
const $InvisibleHandle = styled__default["default"].div `
  position: absolute;
  right: -9px;
  top: 0;
  bottom: 0;
...
function Media({ attributes, children, element, }) {
     ...
     */
    const activeImage = React.useMemo(() => editor.createActiveImage(element.url), [element.url]);
    /**
     * Are we in ready or dragging mode
     */
    const [mode, setMode] = React.useState(() => ({ type: "ready" }));
    /**
     ...
     */
    const [size, setSize] = React.useState(() => activeImage.type === "dynamic"
        ? {
    ...
    const imageClassName = cx__default["default"]({ "--focused": highlighted });
    return (React__default["default"].createElement(SeamlessContainer, { attributes: attributes, element: element },
        React__default["default"].createElement($OuterContainer, null,
            children,
            React__default["default"].createElement($TightContainer, { contentEditable: false },
                React__default["default"].createElement($Image, { src: displayUrl, width: size.width, height: size.height, className: imageClassName }),
                highlighted ? (React__default["default"].createElement(React__default["default"].Fragment, null,
                    mode.type === "drag" ? (React__default["default"].createElement($Size, { className: cx__default["default"]({
                            "--small": typeof size.width === "number" && size.width <= 75,
                        }) },
                        size.width,
                        " \u00D7 ",
                        size.height)) : null,
                    activeImage.type === "dynamic" ? (React__default["default"].createElement(React__default["default"].Fragment, null,
                        React__default["default"].createElement($Handle, null,
                            React__default["default"].createElement("div", { className: "--bar --bar-1" }),
                            React__default["default"].createElement("div", { className: "--bar --bar-2" }),
                            React__default["default"].createElement("div", { className: "--bar --bar-3" })),
                        React__default["default"].createElement($InvisibleHandle, { onMouseDown: onMouseDown }))) : null)) : null))));
}

const ArrowLineUpIcon = (props) => (React__default["default"].createElement("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", width: "1em", height: "1em", viewBox: "0 0 256 256" }, props),
    React__default["default"].createElement("path", { fill: "none", d: "M0 0h256v256H0z" }),
    React__default["default"].createElement("path", { fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 16, d: "M128 224V72M56 144l72-72 72 72M40 40h176" })));
const TrashIcon = (props) => (React__default["default"].createElement("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", width: "1em", height: "1em", viewBox: "0 0 256 256" }, props),
    React__default["default"].createElement("path", { fill: "none", d: "M0 0h256v256H0z" }),
    React__default["default"].createElement("path", { fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 16, d: "M216 56H40M104 104v64M152 104v64M200 56v152a8 8 0 0 1-8 8H64a8 8 0 0 1-8-8V56M168 56V40a16 16 0 0 0-16-16h-48a16 16 0 0 0-16 16v16" })));
const AlignLeftIcon = (props) => (React__default["default"].createElement("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", width: "1em", height: "1em", viewBox: "0 0 256 256" }, props),
    React__default["default"].createElement("path", { fill: "none", d: "M0 0h256v256H0z" }),
    React__default["default"].createElement("path", { fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 16, d: "M40 68h176M40 108h128M40 148h176M40 188h128" })));
const AlignCenterIcon = (props) => (React__default["default"].createElement("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", width: "1em", height: "1em", viewBox: "0 0 256 256" }, props),
    React__default["default"].createElement("path", { fill: "none", d: "M0 0h256v256H0z" }),
    React__default["default"].createElement("path", { fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 16, d: "M40 68h176M64 108h128M40 148h176M64 188h128" })));
const AlignRightIcon = (props) => (React__default["default"].createElement("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", width: "1em", height: "1em", viewBox: "0 0 256 256" }, props),
    React__default["default"].createElement("path", { fill: "none", d: "M0 0h256v256H0z" }),
    React__default["default"].createElement("path", { fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 16, d: "M40 68h176M88 108h128M40 148h176M88 188h128" })));

const PlainTextIcon = (props) => (React__default["default"].createElement("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", width: "1em", height: "1em", viewBox: "0 0 256 256" }, props),
    React__default["default"].createElement("path", { fill: "none", d: "M0 0h256v256H0z" }),
    React__default["default"].createElement("path", { fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 16, d: "M152 192 80 56 8 192" }),
    React__default["default"].createElement("ellipse", { cx: 208, cy: 166.9, rx: 32, ry: 28, fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 16 }),
    React__default["default"].createElement("path", { d: "M184 112.4a34.1 34.1 0 0 1 24-9.5c17.7 0 32 12.5 32 28V192M130.8 152H29.2", fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 16 })));
const HtmlIcon = (props) => (React__default["default"].createElement("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", width: "1em", height: "1em", viewBox: "0 0 256 256" }, props),
    React__default["default"].createElement("path", { fill: "none", d: "M0 0h256v256H0z" }),
    React__default["default"].createElement("path", { fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 16, d: "M120 176H88M104 216v-40M36 176v40M64 176v40M36 196h28M212 176v40h24M144 216v-40l20 28 20-28v40M48 136V40a8 8 0 0 1 8-8h96l56 56v48" }),
    React__default["default"].createElement("path", { fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 16, d: "M152 32v56h56" })));
const CssIcon = (props) => (React__default["default"].createElement("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", width: "1em", height: "1em", viewBox: "0 0 256 256" }, props),
    React__default["default"].createElement("path", { fill: "none", d: "M0 0h256v256H0z" }),
    React__default["default"].createElement("path", { d: "M80 210.5a21 21 0 0 1-14 5.5c-12.2 0-22-10.7-22-24s9.8-24 22-24a21 21 0 0 1 14 5.5M112 212a25.2 25.2 0 0 0 15 5c9 0 17-3 17-13 0-16-32-9-32-24 0-8 6-13 15-13a25.2 25.2 0 0 1 15 5M176 212a25.2 25.2 0 0 0 15 5c9 0 17-3 17-13 0-16-32-9-32-24 0-8 6-13 15-13a25.2 25.2 0 0 1 15 5M48 128V40a8 8 0 0 1 8-8h96l56 56v40", fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 16 }),
    React__default["default"].createElement("path", { fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 16, d: "M152 32v56h56" })));
const JsIcon = (props) => (React__default["default"].createElement("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", width: "1em", height: "1em", viewBox: "0 0 256 256" }, props),
    React__default["default"].createElement("path", { fill: "none", d: "M0 0h256v256H0z" }),
    React__default["default"].createElement("path", { d: "M72 168v32a16 16 0 0 1-32 0M176 224h24a8 8 0 0 0 8-8V88l-56-56H56a8 8 0 0 0-8 8v88", fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 16 }),
    React__default["default"].createElement("path", { d: "M104 212a25.2 25.2 0 0 0 15 5c9 0 17-3 17-13 0-16-32-9-32-24 0-8 6-13 15-13a25.2 25.2 0 0 1 15 5M152 32v56h56", fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 16 })));
const FileCodeIcon = (props) => (React__default["default"].createElement("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", width: "1em", height: "1em", viewBox: "0 0 256 256" }, props),
    React__default["default"].createElement("path", { fill: "none", d: "M0 0h256v256H0z" }),
    React__default["default"].createElement("path", { fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 16, d: "M152 32v56h56M148 128l24 24-24 24M108 128l-24 24 24 24" }),
    React__default["default"].createElement("path", { d: "M200 224a8 8 0 0 0 8-8V88l-56-56H56a8 8 0 0 0-8 8v176a8 8 0 0 0 8 8Z", fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 16 })));

const CheckIcon$1 = (props) => (React__default["default"].createElement("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", width: "1em", height: "1em", viewBox: "0 0 256 256" }, props),
    React__default["default"].createElement("path", { fill: "none", d: "M0 0h256v256H0z" }),
    React__default["default"].createElement("path", { fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 32, d: "M216 72 104 184l-56-56" })));
const XCircleIcon = (props) => (React__default["default"].createElement("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", width: "1em", height: "1em", viewBox: "0 0 256 256" }, props),
    React__default["default"].createElement("path", { fill: "none", d: "M0 0h256v256H0z" }),
    React__default["default"].createElement("circle", { cx: 128, cy: 128, r: 96, fill: "none", stroke: "currentColor", strokeMiterlimit: 10, strokeWidth: 16 }),
    React__default["default"].createElement("path", { fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 16, d: "m160 96-64 64M160 160 96 96" })));
const PlusIcon = (props) => (React__default["default"].createElement("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", width: "1em", height: "1em", viewBox: "0 0 256 256" }, props),
    React__default["default"].createElement("path", { fill: "none", d: "M0 0h256v256H0z" }),
    React__default["default"].createElement("path", { fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 16, d: "M40 128h176M128 40v176" })));
/**
 * Converted from
 *
 ...
 */
const CheckedIcon = (props) => (React__default["default"].createElement("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", width: 192, height: 192, viewBox: "0 0 256 256" }, props),
    React__default["default"].createElement("path", { fill: "none", d: "M0 0h256v256H0z" }),
    React__default["default"].createElement("path", { fill: "#2888ff", d: "M208 32H48a16 16 0 0 0-16 16v160a16 16 0 0 0 16 16h160a16 16 0 0 0 16-16V48a16 16 0 0 0-16-16Zm-30.5 77.8-58.6 56a8.1 8.1 0 0 1-5.6 2.2 7.9 7.9 0 0 1-5.5-2.2l-29.3-28a8 8 0 1 1 11-11.6l23.8 22.7 53.2-50.7a8 8 0 0 1 11 11.6Z" })));
function UncheckedIcon(props) {
    return (React__default["default"].createElement("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", width: 192, height: 192, viewBox: "0 0 256 256" }, props),
        React__default["default"].createElement("path", { fill: "none", d: "M0 0h256v256H0z" }),
        React__default["default"].createElement("rect", { x: 40, y: 40, width: 176, height: 176, rx: 8, fill: "none", stroke: "#d0d0d0", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 16 })));
}
const H1Icon = (props) => (React__default["default"].createElement("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", width: "1em", height: "1em", viewBox: "0 0 256 256" }, props),
    React__default["default"].createElement("path", { fill: "none", d: "M0 0h256v256H0z" }),
    React__default["default"].createElement("path", { fill: "none", stroke: "currentColor", strokeLinecap: "square", strokeLinejoin: "miter", strokeWidth: 16, d: "M40 56v120M144 116H40M144 56v120M196 124l24-16v92" })));
const H2Icon = (props) => (React__default["default"].createElement("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", width: "1em", height: "1em", viewBox: "0 0 256 256" }, props),
    React__default["default"].createElement("path", { fill: "none", d: "M0 0h256v256H0z" }),
    React__default["default"].createElement("path", { fill: "none", stroke: "currentColor", strokeLinecap: "square", strokeLinejoin: "miter", strokeWidth: 16, d: "M40 56v120M144 116H40M144 56v120M193.9 118.7A24 24 0 0 1 240 128a23.6 23.6 0 0 1-4.1 13.4h0L192 200h48" })));
const H3Icon = (props) => (React__default["default"].createElement("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", width: "1em", height: "1em", viewBox: "0 0 256 256" }, props),
    React__default["default"].createElement("path", { fill: "none", d: "M0 0h256v256H0z" }),
    React__default["default"].createElement("path", { fill: "none", stroke: "currentColor", strokeLinecap: "square", strokeLinejoin: "miter", strokeWidth: 16, d: "M40 56v120M144 116H40M144 56v120M192 108h48l-28 40a28 28 0 1 1-19.8 47.8" })));
const BoldIcon = (props) => (React__default["default"].createElement("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", width: "1em", height: "1em", viewBox: "0 0 256 256" }, props),
    React__default["default"].createElement("path", { fill: "none", d: "M0 0h256v256H0z" }),
    React__default["default"].createElement("path", { d: "M64 120h88a40 40 0 0 1 0 80H64V48h76a36 36 0 0 1 0 72", fill: "none", stroke: "currentColor", strokeLinecap: "square", strokeLinejoin: "miter", strokeWidth: 24 })));
const ItalicIcon = (props) => (React__default["default"].createElement("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", width: "1em", height: "1em", viewBox: "0 0 256 256" }, props),
    React__default["default"].createElement("path", { fill: "none", d: "M0 0h256v256H0z" }),
    React__default["default"].createElement("path", { fill: "none", stroke: "currentColor", strokeLinecap: "square", strokeLinejoin: "miter", strokeWidth: 16, d: "m152 56-48 144M64 200h80M112 56h80" })));
const LinkIcon = (props) => (React__default["default"].createElement("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", width: "1em", height: "1em", viewBox: "0 0 256 256" }, props),
    React__default["default"].createElement("path", { fill: "none", d: "M0 0h256v256H0z" }),
    React__default["default"].createElement("path", { d: "m132.5 61.3 9.6-9.7a44.1 44.1 0 0 1 62.3 62.3l-30.3 30.2a43.9 43.9 0 0 1-62.2 0", fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 16 }),
    React__default["default"].createElement("path", { d: "m123.5 194.7-9.6 9.7a44.1 44.1 0 0 1-62.3-62.3l30.3-30.2a43.9 43.9 0 0 1 62.2 0", fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 16 })));
const QuoteIcon = (props) => (React__default["default"].createElement("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", width: "1em", height: "1em", viewBox: "0 0 256 256" }, props),
    React__default["default"].createElement("path", { fill: "none", d: "M0 0h256v256H0z" }),
    React__default["default"].createElement("path", { d: "M108 144H40a8 8 0 0 1-8-8V72a8 8 0 0 1 8-8h60a8 8 0 0 1 8 8v88a40 40 0 0 1-40 40M224 144h-68a8 8 0 0 1-8-8V72a8 8 0 0 1 8-8h60a8 8 0 0 1 8 8v88a40 40 0 0 1-40 40", fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 16 })));
const BlockquoteIndentIcon = (props) => (React__default["default"].createElement("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", width: "1em", height: "1em", viewBox: "0 0 256 256" }, props),
    React__default["default"].createElement("path", { fill: "none", d: "M0 0h256v256H0z" }),
    React__default["default"].createElement("path", { fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 16, d: "M32 128h152M112 56l72 72-72 72M216 40v176" })));
const BlockquoteOutdentIcon = (props) => (React__default["default"].createElement("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", width: "1em", height: "1em", viewBox: "0 0 256 256" }, props),
    React__default["default"].createElement("path", { fill: "none", d: "M0 0h256v256H0z" }),
    React__default["default"].createElement("path", { fill: "none", stroke: "#000", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 16, d: "M224 128H72M144 56l-72 72 72 72M40 40v176" })));
const TableIcon = (props) => (React__default["default"].createElement("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", width: "1em", height: "1em", viewBox: "0 0 256 256" }, props),
    React__default["default"].createElement("path", { fill: "none", d: "M0 0h256v256H0z" }),
    React__default["default"].createElement("path", { d: "M32 56h192v136a8 8 0 0 1-8 8H40a8 8 0 0 1-8-8V56h0ZM32 104h192M32 152h192M88 104v96", fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 12 })));
const CodeIcon = (props) => (React__default["default"].createElement("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", width: "1em", height: "1em", viewBox: "0 0 256 256" }, props),
    React__default["default"].createElement("path", { fill: "none", d: "M0 0h256v256H0z" }),
    React__default["default"].createElement("path", { fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 16, d: "m64 88-48 40 48 40M192 88l48 40-48 40M160 40 96 216" })));
const ImageIcon = (props) => (React__default["default"].createElement("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", width: "1em", height: "1em", viewBox: "0 0 256 256" }, props),
    React__default["default"].createElement("path", { fill: "none", d: "M0 0h256v256H0z" }),
    React__default["default"].createElement("rect", { x: 32, y: 48, width: 192, height: 160, rx: 8, fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 14 }),
    React__default["default"].createElement("path", { d: "m32 168 50.3-50.3a8 8 0 0 1 11.4 0l44.6 44.6a8 8 0 0 0 11.4 0l20.6-20.6a8 8 0 0 1 11.4 0L224 184", fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 14 }),
    React__default["default"].createElement("circle", { cx: 156, cy: 100, r: 12, fill: "currentColor" })));
const EllipsisIcon = (props) => (React__default["default"].createElement("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", width: "1em", height: "1em", viewBox: "0 0 256 256" }, props),
    React__default["default"].createElement("path", { fill: "none", d: "M0 0h256v256H0z" }),
    React__default["default"].createElement("circle", { cx: 128, cy: 128, r: 16, fill: "currentColor" }),
    React__default["default"].createElement("circle", { cx: 192, cy: 128, r: 16, fill: "currentColor" }),
    React__default["default"].createElement("circle", { cx: 64, cy: 128, r: 16, fill: "currentColor" })));
/**
 * Modified `arrows-in-line-vertical`
 */
const HrIcon = (props) => (React__default["default"].createElement("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", width: "1em", height: "1em", viewBox: "0 0 256 256" }, props),
    React__default["default"].createElement("path", { fill: "none", d: "M0 0h256v256H0z" }),
    React__default["default"].createElement("path", { fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 16, d: "M216 128H40" })));
const CaretDown = (props) => (React__default["default"].createElement("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", width: "1em", height: "1em", viewBox: "0 0 256 256" }, props),
    React__default["default"].createElement("path", { fill: "none", d: "M0 0h256v256H0z" }),
    React__default["default"].createElement("path", { fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 16, d: "m208 96-80 80-80-80" })));
const StrikeIcon = (props) => (React__default["default"].createElement("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", width: "1em", height: "1em", viewBox: "0 0 256 256" }, props),
    React__default["default"].createElement("path", { fill: "none", d: "M0 0h256v256H0z" }),
    React__default["default"].createElement("path", { fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 16, d: "M40 128h176M76.3 96a25.3 25.3 0 0 1-1.2-8c0-22.1 22-40 52.9-40 23.8 0 42.3 10.6 49.5 25.5M72 168c0 22.1 25.1 40 56 40s56-17.9 56-40c0-23.8-21.6-33-45.6-40" })));
const IndentIcon = (props) => (React__default["default"].createElement("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", width: "1em", height: "1em", viewBox: "0 0 256 256" }, props),
    React__default["default"].createElement("path", { fill: "none", d: "M0 0h256v256H0z" }),
    React__default["default"].createElement("path", { fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 16, d: "M112 128h104M112 64h104M40 192h176M40 56l40 40-40 40" })));
const OutdentIcon = (props) => (React__default["default"].createElement("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", width: "1em", height: "1em", viewBox: "0 0 256 256" }, props),
    React__default["default"].createElement("path", { fill: "none", d: "M0 0h256v256H0z" }),
    React__default["default"].createElement("path", { fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 16, d: "M112 128h104M112 64h104M40 192h176M72 56 32 96l40 40" })));
const ChecklistIcon = (props) => (React__default["default"].createElement("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", width: "1em", height: "1em", viewBox: "0 0 256 256" }, props),
    React__default["default"].createElement("path", { fill: "none", d: "M0 0h256v256H0z" }),
    React__default["default"].createElement("path", { fill: "none", stroke: "#000", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 16, d: "M128 128h88M128 64h88M128 192h88M92 48 57.3 80 40 64M92 112l-34.7 32L40 128M92 176l-34.7 32L40 192" })));
const UnorderedListIcon = (props) => (React__default["default"].createElement("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", width: "1em", height: "1em", viewBox: "0 0 256 256" }, props),
    React__default["default"].createElement("path", { fill: "none", d: "M0 0h256v256H0z" }),
    React__default["default"].createElement("path", { fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 16, d: "M88 64h128M88 128h128M88 192h128" }),
    React__default["default"].createElement("circle", { cx: 44, cy: 64, r: 12, fill: "currentColor" }),
    React__default["default"].createElement("circle", { cx: 44, cy: 128, r: 12, fill: "currentColor" }),
    React__default["default"].createElement("circle", { cx: 44, cy: 192, r: 12, fill: "currentColor" })));
const OrderedListIcon = (props) => (React__default["default"].createElement("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", width: "1em", height: "1em", viewBox: "0 0 256 256" }, props),
    React__default["default"].createElement("path", { fill: "none", d: "M0 0h256v256H0z" }),
    React__default["default"].createElement("path", { stroke: "#000", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 16, d: "M104 128h112M104 64h112M104 192h112" }),
    React__default["default"].createElement("path", { fill: "none", stroke: "#000", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 16, d: "m40 60 16-8v56M41.1 152.6a14 14 0 1 1 24.5 13.2L40 200h28" })));
const SuperscriptIcon = (props) => (React__default["default"].createElement("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", width: "1em", height: "1em", viewBox: "0 0 256 256" }, props),
    React__default["default"].createElement("path", { fill: "none", d: "M0 0h256v256H0z" }),
    React__default["default"].createElement("rect", { x: 40, y: 40, width: 176, height: 176, rx: 8, fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 16 }),
    React__default["default"].createElement("path", { fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 16, d: "M94.1 121.9 128 88l33.9 33.9M128 168V88" })));
const SubscriptIcon = (props) => (React__default["default"].createElement("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", width: "1em", height: "1em", viewBox: "0 0 256 256" }, props),
    React__default["default"].createElement("path", { fill: "none", d: "M0 0h256v256H0z" }),
    React__default["default"].createElement("rect", { x: 40, y: 40, width: 176, height: 176, rx: 8, fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 16 }),
    React__default["default"].createElement("path", { fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 16, d: "M94.1 134.1 128 168l33.9-33.9M128 88v80" })));

const CheckIcon = (props) => (React__default["default"].createElement("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", width: "1em", height: "1em", viewBox: "0 0 256 256" }, props),
    React__default["default"].createElement("path", { fill: "none", d: "M0 0h256v256H0z" }),
    React__default["default"].createElement("path", { fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 16, d: "M216 72 104 184l-56-56" })));
const ClipboardTextIcon = (props) => (React__default["default"].createElement("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", width: "1em", height: "1em", viewBox: "0 0 256 256" }, props),
    React__default["default"].createElement("path", { fill: "none", d: "M0 0h256v256H0z" }),
    React__default["default"].createElement("path", { fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 16, d: "M96 152h64M96 120h64M160 40h40a8 8 0 0 1 8 8v168a8 8 0 0 1-8 8H56a8 8 0 0 1-8-8V48a8 8 0 0 1 8-8h40" }),
    React__default["default"].createElement("path", { d: "M88 72v-8a40 40 0 0 1 80 0v8Z", fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 16 })));
const PencilIcon = (props) => (React__default["default"].createElement("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", width: "1em", height: "1em", viewBox: "0 0 256 256" }, props),
    React__default["default"].createElement("path", { fill: "none", d: "M0 0h256v256H0z" }),
    React__default["default"].createElement("path", { d: "M92.7 216H48a8 8 0 0 1-8-8v-44.7a7.9 7.9 0 0 1 2.3-5.6l120-120a8 8 0 0 1 11.4 0l44.6 44.6a8 8 0 0 1 0 11.4l-120 120a7.9 7.9 0 0 1-5.6 2.3ZM136 64l56 56M164 92l-96 96M95.5 215.5l-55-55", fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 16 })));
const LinkBreakIcon = (props) => (React__default["default"].createElement("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", width: "1em", height: "1em", viewBox: "0 0 256 256" }, props),
    React__default["default"].createElement("path", { fill: "none", d: "M0 0h256v256H0z" }),
    React__default["default"].createElement("path", { fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 16, d: "M96 72V48M160 208v-24M72 96H48M208 160h-24M71 128.4l-11.3 11.3a40 40 0 0 0 56.6 56.6l11.3-11.3M185 127.6l11.3-11.3a40 40 0 0 0-56.6-56.6L128.4 71" })));

const Fault$1 = styled__default["default"].div `
  color: #cc0000;
  font-weight: 600;
  font-size: 14px;
  line-height: 20px;
...
const Hint = styled__default["default"].div `
  color: #8b91a4;
  font-size: 14px;
  line-height: 20px;
  margin-top: 4px;
...
function Block(_a) {
    ...
    return (React__default["default"].createElement($Block, Object.assign({}, props),
        label ? React__default["default"].createElement(Label, null, label) : null,
        children,
        fault ? React__default["default"].createElement(Fault$1, null, fault) : null,
        hint ? React__default["default"].createElement(Hint, null, hint) : null));
}

const Focus = core.css `
  border-color: #80bdff;
  border: 1px solid rgb(128, 189, 255);
  box-shadow: 0 0 0 3px rgba(0, 123, 255, 0.25);
  outline: none;
`;
const InputBox = core.css `
...
function Button$1(props) {
    return React__default["default"].createElement($Button, Object.assign({}, props));
}
styled__default["default"].div `
  margin-top: 24px;
`;

const $Close = styled__default["default"].div `
  color: #8b91a4;
  cursor: pointer;
  font-size: 30px;
  font-weight: 300;
...
function Close(props) {
    return React__default["default"].createElement($Close, Object.assign({}, props), "\u00D7");
}

const initialStyles = core.css `
  &.--initial {
    opacity: 0;
...
const Dialog$1 = styled__default["default"].div `
  ${initialStyles}
  background: white;
  border-radius: 8px;
...
function File({ onChange, children, }) {
    return (React__default["default"].createElement($Label, null,
        React__default["default"].createElement($Input$1, { type: "file", multiple: true, onChange: onChange }),
        React__default["default"].createElement($DivButton, null, children)));
}

const Heading$1 = styled__default["default"].h1 `
  color: #46535e;
  font-size: 20px;
  font-weight: 500;
`;

const $Input = styled__default["default"].input(InputBox);
const isEnter$1 = isHotkey__default["default"]("enter");
const isModEnter$1 = isHotkey__default["default"]("mod+enter");
function Input(_a) {
    ...
    return React__default["default"].createElement($Input, Object.assign({ onKeyDown: handleKeyDown }, props));
}

const $Progress = styled__default["default"].div `
  background: #e8e9ea;
...
function Progress(_a) {
    ...
    return (React__default["default"].createElement($Progress, Object.assign({}, props),
        React__default["default"].createElement($ProgressBar, { style: { width: `${width}%` } })));
}

const $TextArea = styled__default["default"].textarea(InputBox);
const isEnter = isHotkey__default["default"]("enter");
const isModEnter = isHotkey__default["default"]("mod+enter");
function TextArea(_a) {
    ...
    return React__default["default"].createElement($TextArea, Object.assign({ onKeyDown: handleKeyDown }, props));
}
...
function useHotkey(key, callback, deps, isEnabled = () => true) {
    const isKey = isHotkey__default["default"](key);
...
const CONTAINER_STYLE = core.css `
  background: white;
...
function Mask({ children }) {
    ...
    return (React__default["default"].createElement($Mask, { ref: ref, onClick: close, style: { zIndex: modal.zIndex } }, children));
}

function Body(props) {
    return React__default["default"].createElement("div", Object.assign({ className: "modal-body" }, props));
}
function Dialog({ dest, title, children, position, width, }) {
    ...
    const className = cx__default["default"]({ "--initial": initial });
    /**
     * TODO:
     * Fix as const and provide the proper CSS type for a div
     */
    const style = Object.assign({ position: "absolute", width }, pos);
    return (React__default["default"].createElement(ResetContainer, null,
        React__default["default"].createElement(Mask, null,
            React__default["default"].createElement(Form$1.Dialog, { ref: ref, style: style, className: className },
                React__default["default"].createElement(Form$1.Block, null,
                    title ? React__default["default"].createElement(Form$1.Heading, null, title) : null,
                    React__default["default"].createElement(Form$1.Close, { onClick: modal.close })),
                children))));
}
Dialog.Body = Body;
...
function useForm(initialValues, initialFaults = {}) {
    ...
    const [faults, setFaults] = React.useState(initialFaults);
...
function InsertLinkDialog({ dest, editor, }) {
     ...
     */
    const linkInfoRef = React.useRef(getLinkInfo(editor));
    ...
    function submit() {
        form.submit(({ url, label }) => __awaiter(this, void 0, void 0, function* () {
            ...
            slateReact.ReactEditor.focus(editor);
            slate.Transforms.select(editor, linkInfo.range);
            insertLink(editor, url, labelToInsert);
            modal.close();
        }));
    }
    const title = linkInfo.text.length > 0 ? "Edit link" : "Insert link";
    return (React__default["default"].createElement(Dialog, { title: title, dest: dest, width: 320 },
        React__default["default"].createElement(Form$1.Block, { label: "URL", fault: urlField.fault },
            React__default["default"].createElement(Form$1.Input, { value: urlField.value, onChange: urlField.onChange, onSubmit: submit, autoFocus: true })),
        React__default["default"].createElement(Form$1.Block, { label: "Link text", fault: labelField.fault },
            React__default["default"].createElement(Form$1.Input, { value: labelField.value, onChange: labelField.onChange, onSubmit: submit, placeholder: "Use URL above when empty" })),
        React__default["default"].createElement(Form$1.Block, null,
            React__default["default"].createElement(Form$1.Button, { onClick: submit },
                React__default["default"].createElement("i", { className: "fa fa-link" }),
                "Insert Link"))));
}
...
const $TriangleBase = styled__default["default"].div `
  position: fixed;
  top: -1000px;
  left: -1000px;
  width: 0;
...
`;
const $TopTriangle = styled__default["default"]($TriangleBase) `
  border-bottom: ${TRIANGLE_HEIGHT}px solid ${BACKGROUND_COLOR}; /* height */
`;
const $BottomTriangle = styled__default["default"]($TriangleBase) `
  border-top: ${TRIANGLE_HEIGHT}px solid ${BACKGROUND_COLOR}; /* height */
`;
const $Callout = styled__default["default"].div `
  position: fixed;
  color: #e0e0e0;
...
function Callout({ dest, hotkey, label, className, }) {
    ...
    return (React__default["default"].createElement(ResetContainer, null,
        position === Position.Above ? (React__default["default"].createElement($BottomTriangle, { className: className, style: Object.assign({ zIndex: modal.zIndex }, trianglePos) })) : (React__default["default"].createElement($TopTriangle, { className: className, style: Object.assign({ zIndex: modal.zIndex }, trianglePos) })),
        React__default["default"].createElement($Callout, { ref: tooltipRef, style: Object.assign({ zIndex: modal.zIndex }, tooltipPos), className: className },
            React__default["default"].createElement("span", { className: "label" }, label),
            hotkey ? React__default["default"].createElement("span", { className: "hotkey" }, formatHotkey(hotkey)) : null)));
}
var Position;
(function (Position) {
...
const $LinkDialog = styled__default["default"].div `
  position: absolute;
...
function LinkPopup({ element, linkRef, copy, }) {
     ...
     */
    const clickRemove = React.useCallback(() => {
        const linkInfo = getLinkInfo(editor);
        if (linkInfo.path != null) {
            slate.Transforms.unwrapNodes(editor, { at: linkInfo.path });
            slateReact.ReactEditor.focus(editor);
        }
    }, [element]);
    if (linkRef.current == null)
    ...
    const style = Object.assign(Object.assign({}, fitInViewport({ left: rect.left, top: rect.bottom + 4 + window.scrollY }, { width: 324 })), { 
        ...
        zIndex: 10000 });
    return (React__default["default"].createElement(Portal, null,
        React__default["default"].createElement(Reset, null,
            React__default["default"].createElement($LinkDialog, { style: style, className: className },
                React__default["default"].createElement("div", { className: "--globe-icon" },
                    React__default["default"].createElement(LinkIcon, null)),
                React__default["default"].createElement(Tooltip, { label: "Open URL in new tab" },
                    React__default["default"].createElement("a", { href: element.url, target: "_blank", rel: "noreferrer", onMouseDown: stopEvent }, element.url)),
                React__default["default"].createElement("div", { className: "--icons" },
                    React__default["default"].createElement(Tooltip, { label: "Copy URL to clipboard" },
                        React__default["default"].createElement("span", { className: "--icon", onMouseDown: clickCopy }, copied == false ? React__default["default"].createElement(ClipboardTextIcon, null) : React__default["default"].createElement(CheckIcon, null))),
                    React__default["default"].createElement(Tooltip, { label: "Edit link" },
                        React__default["default"].createElement("span", { className: "--icon", onMouseDown: clickEdit },
                            React__default["default"].createElement(PencilIcon, null))),
                    React__default["default"].createElement(Tooltip, { label: "Unlink" },
                        React__default["default"].createElement("span", { className: "--icon", onMouseDown: clickRemove },
                            React__default["default"].createElement(LinkBreakIcon, null))))))));
}
...
function Link({ attributes, children, element, }) {
    ...
    const copy = React.useCallback(() => {
        setIsCopying(true);
        copyToClipboard__default["default"](element.url);
        setTimeout(() => {
            setIsCopying(false);
        });
    }, []);
    return (React__default["default"].createElement("a", Object.assign({}, attributes, { href: element.url, ref: linkRef }),
        isPopupVisible ? (React__default["default"].createElement(LinkPopup, { linkRef: linkRef, element: element, copy: copy })) : null,
        children));
}
/**
...
function checkIsPopupVisible(editor, element, highlighted) {
    ...
    if (!editor.selection)
        return false;
    const elementPath = slateReact.ReactEditor.findPath(editor, element);
    /**
     ...
     */
    const elementRange = slate.Editor.range(editor, elementPath);
    const intersection = slate.Range.intersection(editor.selection, elementRange);
    if (!intersection)
        return false;
    return (slate.Point.equals(slate.Range.start(editor.selection), slate.Range.start(intersection)) &&
        slate.Point.equals(slate.Range.end(editor.selection), slate.Range.end(intersection)));
}
...
function useListItemClassName(className) {
    ...
    return cx__default["default"](className, { "--is-editing": !readOnly });
}
/**
 * Task list item
 */
function TaskListItem({ attributes, element, children, }) {
    ...
    const clickTaskListElement = React.useCallback(function clickTaskListElement(checked) {
        const path = slateReact.ReactEditor.findPath(editor, element);
        slate.Transforms.setNodes(editor, { checked }, { at: path });
    }, []);
    return (React__default["default"].createElement("ul", Object.assign({}, attributes, { className: className, style: style }),
        React__default["default"].createElement("li", null,
            React__default["default"].createElement("span", { contentEditable: false }, element.checked ? (React__default["default"].createElement(CheckedIcon, { onClick: () => clickTaskListElement(false), width: "1.25em", height: "1.25em" })) : (React__default["default"].createElement(UncheckedIcon, { onClick: () => clickTaskListElement(true), width: "1.25em", height: "1.25em" }))),
            children)));
}
/**
 * Unordered list item
...
function UnorderedListItem({ attributes, element, children, }) {
    ...
    const style = getIndentStyle(element);
    return (React__default["default"].createElement("ul", Object.assign({}, attributes, { className: className, style: style }),
        React__default["default"].createElement("li", null, children)));
}
/**
 * Ordered list item
 *
...
function OrderedListItem({ attributes, element, children, }) {
    ...
    const style = getIndentStyle(element);
    return (React__default["default"].createElement("ol", Object.assign({}, attributes, { className: className, style: style }),
        React__default["default"].createElement("li", { value: element.number }, children)));
}
...
function Heading(props) {
    ...
    const Tag = `h${level}`;
    const text = slate.Node.string(props.element);
    return (React__default["default"].createElement(Tag, Object.assign({}, props.attributes, { id: text }), props.children));
}
/**
 * Paragraph
 */
function Paragraph(props) {
    return React__default["default"].createElement("p", Object.assign({}, props.attributes), props.children);
}
...
function Table({ attributes, children, element, }) {
    ...
    return (React__default["default"].createElement(TableContext.Provider, { value: contextValue },
        React__default["default"].createElement(SeamlessContainer, { attributes: attributes, element: element },
            React__default["default"].createElement("table", { className: initialClassName },
...
function Tr({ attributes, children }) {
    return React__default["default"].createElement("tr", Object.assign({}, attributes), children);
}
/**
 * Render `td`
 */
function Td(props) {
    ...
    return (React__default["default"].createElement("td", Object.assign({}, attributes, { style: style }), children));
}
...
function renderElement(props) {
    ...
    switch (element.type) {
         ...
         */
        case "heading":
            return React__default["default"].createElement(Heading, Object.assign({}, props, { element: element }));
        case "p":
            return React__default["default"].createElement(Paragraph, Object.assign({}, props, { element: element }));
        /**
         * Inline Segments
         */
        case "link":
            return React__default["default"].createElement(Link, Object.assign({}, props, { element: element }));
        /**
         * Block Quote
         */
        case "blockquote":
            return React__default["default"].createElement(BlockQuote, Object.assign({}, props, { element: element }));
        /**
         * Code Block
         */
        case "code-block":
            return React__default["default"].createElement(CodeBlock, Object.assign({}, props, { element: element }));
        case "code-line":
            return React__default["default"].createElement(CodeLine, Object.assign({}, props, { element: element }));
        /**
         * Media
         */
        case "media":
            return React__default["default"].createElement(Media, Object.assign({}, props, { element: element }));
        /**
         * Horizontal Rule
         */
        case "hr":
            return React__default["default"].createElement(HorizontalRule, Object.assign({}, props, { element: element }));
        /**
         * List
         */
        case "unordered-list-item":
            return React__default["default"].createElement(UnorderedListItem, Object.assign({}, props, { element: element }));
        case "ordered-list-item":
            return React__default["default"].createElement(OrderedListItem, Object.assign({}, props, { element: element }));
        case "task-list-item":
            return React__default["default"].createElement(TaskListItem, Object.assign({}, props, { element: element }));
        /**
         * Table
         */
        case "table":
            return React__default["default"].createElement(Table, Object.assign({}, props, { element: element }));
        case "tr":
            return React__default["default"].createElement(Tr, Object.assign({}, props, { element: element }));
        case "td":
            return React__default["default"].createElement(Td, Object.assign({}, props, { element: element }));
        default:
 ...
 */
const $Leaf = styled__default["default"].span `
  &.token-comment {
...
function renderLeaf(props) {
    ...
    return (React__default["default"].createElement($Leaf, Object.assign({}, attributes, { className: className, spellCheck: spellCheck }), children));
}
...
function decorate(nodeEntry) {
    ...
    if (node.type !== "code-block")
        return [];
    const lang = Prism__default["default"].languages[node.language];
    if (lang === undefined)
        return [];
    /**
    ...
    const textLines = codeLineElements.map((node) => `${slate.Node.string(node)}\n`);
    ...
    const ranges = [];
    const tokens = Prism__default["default"].tokenize(text, lang);
    /**
...
const $Editable = styled__default["default"](slateReact.Editable) `
  color: #101010;
  background: #ffffff;
...
function CustomEditable({ "data-cy": dataCy, readOnly, className: classNameProp, onBlur, }) {
     ...
     */
    const className = cx__default["default"](classNameProp, {
        "--focus": slateReact.ReactEditor.isFocused(editor),
    });
    /**
     * onKeyDown with Editor
     */
    const onBoundKeyDown = React.useCallback((e) => onKeyDown(e, editor), [editor]);
    /**
     * onPaste with Editor
     */
    const onBoundPaste = React.useCallback((e) => onPaste(e, editor), [editor]);
    /**
     * onDrop with Editor
     */
    const onBoundDrop = React.useCallback((e) => onDrop(e, editor), [editor]);
    /**
     ...
     */
    return (React__default["default"].createElement($Editable, { spellCheck: "false", autoCorrect: "false", autoCapitalize: "false", className: className, "data-cy": dataCy, decorate: decorate, readOnly: readOnly, renderElement: renderElement, renderLeaf: renderLeaf, onKeyDown: onBoundKeyDown, onPaste: onBoundPaste, onDrop: onBoundDrop, onSelect: onSelect, onBlur: onBlur }));
}
...
function InsertImageDialog({ dest, editor, }) {
    ...
    return (React__default["default"].createElement(Dialog, { title: "Insert image", dest: dest, width: 320 },
        React__default["default"].createElement(Form$1.Block, { label: "Select image file to upload", hint: "Works with .gif, .jpg/.jpeg and .png" },
            React__default["default"].createElement(Form$1.File, { onChange: onChange },
                React__default["default"].createElement("i", { className: "fa fa-upload" }),
                " Upload Image"))));
}
 ...
 * Styled Components
 */
const $Menu = styled__default["default"](Container$1) `
  display: block;
  margin-top: 0;
...
function Item({ SvgIcon, iconProps, active = false, hotkey, children, onClick, onMouseDown, danger, muted, }) {
    const modal = useInModal();
    useHotkey("escape", () => modal.close(), [modal]);
    const className = cx__default["default"]("dropdown-item", { "--active": active });
    const textClassName = cx__default["default"]("text", {
        "text-danger": danger,
        "text-muted": muted,
    });
    ...
    return (React__default["default"].createElement($Item, { className: className, onClick: clickItem, onMouseDown: onMouseDown },
        React__default["default"].createElement(CheckIcon$1, { className: "--check" }),
        SvgIcon ? React__default["default"].createElement(SvgIcon, Object.assign({}, iconProps)) : null,
        React__default["default"].createElement("div", { className: textClassName }, children),
        hotkey ? React__default["default"].createElement("div", { className: "shortcut" }, formatHotkey(hotkey)) : null));
}
/**
 * Menu Heading
 */
const $Heading = styled__default["default"].div `
  cursor: default;
...
function Menu({ children, dest, position = Position$1.Below, }) {
    ...
    const initial = useInitial();
    const className = cx__default["default"]({ "--initial": initial, "--not-initial": !initial });
    return (React__default["default"].createElement(ResetContainer, null,
        React__default["default"].createElement(Mask, null,
            React__default["default"].createElement($Menu, { ref: ref, style: style, className: className }, children))));
}
Menu.Item = Item;
...
items, dest, editor, toolbarState, }) {
    const modal = useInModal();
    return (React__default["default"].createElement(Menu, { dest: dest },
        children,
        items.map((item, index) => {
            if (isCommand(item)) {
                ...
                return (React__default["default"].createElement(Menu.Item, { key: item.label, SvgIcon: item.SvgIcon, iconProps: item.iconProps, hotkey: item.hotkey, onMouseDown: onMouseDown, active: active }, item.label));
            }
            else {
                return React__default["default"].createElement(Menu.Divider, { key: index });
            }
        })));
}
...
function SelectTableSizeGrid({ cols, rows, editor, }) {
    ...
    return (React__default["default"].createElement($Grid, { className: "-wysimark-table-grid" },
        React__default["default"].createElement("div", { className: "__title" }, pos == null ? "Insert table" : `${pos[0]}x${pos[1]} table`),
        React__default["default"].createElement("table", { onMouseLeave: () => setPos(null), unselectable: "on" },
            React__default["default"].createElement("tbody", null, range_1(1, rows + 1).map((row) => (React__default["default"].createElement("tr", { key: row }, range_1(1, cols + 1).map((col) => {
                const isSelected = pos != null && col <= pos[0] && row <= pos[1];
                return (React__default["default"].createElement("td", { key: col, className: isSelected ? "selected" : undefined, onMouseDown: (e) => onInsertTable(e, col, row), onMouseEnter: () => setPos([col, row]) }));
            }))))))));
}
function TableMenu({ editor, dest, toolbarState, }) {
    return (React__default["default"].createElement(ToolbarMenu, { editor: editor, dest: dest, items: TableCommands, toolbarState: toolbarState },
        React__default["default"].createElement(SelectTableSizeGrid, { editor: editor, cols: 6, rows: 3 })));
}
...
function getUpwardNodesFromEditor(editor, selection) {
    const nodes = Array.from(slate.Node.levels(editor, selection.focus.path, { reverse: true })).map(([node]) => node);
    return nodes;
}
/**
...
const $ButtonGroup = styled__default["default"].div `
  ...
  padding: 0 8px;
`;
const $IconButtons = styled__default["default"].div `
  /* flex item */
  flex: 0 1 auto;
`;
const $IconButton = styled__default["default"].div `
  display: inline-block;
  cursor: pointer;
  width: 32px;
  height: 40px;
...
function DropdownIcon() {
    return (React__default["default"].createElement($DropdownIcon, null,
        React__default["default"].createElement(CaretDown, null)));
}
function Button({ command, editor, toolbarState, }) {
    ...
    const className = cx__default["default"]({ "--active": active });
    ...
    return (React__default["default"].createElement(Tooltip, { label: label, hotkey: hotkey },
        React__default["default"].createElement($IconButton, { className: className, tabIndex: -1, ref: ref, unselectable: "on", onMouseDown: onMouseDown, style: { position: "relative" } },
            SvgIcon ? React__default["default"].createElement(SvgIcon, { className: "wm-svg-icon" }) : null,
            dropdown ? React__default["default"].createElement(DropdownIcon, null) : null)));
}
function ButtonGroup({ className, items, toolbarState, disable = [], }) {
    const editor = slateReact.useSlate();
    return (React__default["default"].createElement($ButtonGroup, { className: className }, items.map((item) => {
        if (isCommand(item) &&
            !disable.includes("id" in item ? (item.id !== undefined ? item.id : "") : "")) {
            return (React__default["default"].createElement(Button, { key: item.label, command: item, editor: editor, toolbarState: toolbarState }));
        }
        else {
            return null;
        }
...
const RenderEditorToolbar = React__default["default"].memo(function RenderEditorToolbar({ toolbarState, focused, }) {
    const className = cx__default["default"]({ "--focused": focused });
    return (React__default["default"].createElement($Toolbar, { tabIndex: -1, className: className },
        React__default["default"].createElement($IconButtons, null,
            React__default["default"].createElement(ButtonGroup, { items: SIMPLE_COMMANDS, toolbarState: toolbarState }),
            React__default["default"].createElement(ButtonGroup, { items: MARK_COMMANDS, toolbarState: toolbarState }),
            React__default["default"].createElement(ButtonGroup, { items: PLUS_COMMANDS, className: "--mobile-only", toolbarState: toolbarState }),
            React__default["default"].createElement(ButtonGroup, { items: INSERT_COMMANDS, className: "--desktop-only", toolbarState: toolbarState, disable: ["insert-file"] }))));
});
function EditorToolbar() {
    const editor = slateReact.useSlate();
    const focused = slateReact.useFocused();
    const toolbarState = getToolbarState(editor);
    return React__default["default"].createElement(RenderEditorToolbar, { focused: focused, toolbarState: toolbarState });
}
...
function Container({ "data-cy": dataCy, showInitial = false, minHeight = 240, maxHeight, onBlur, }) {
     ...
     */
    const className = cx__default["default"](initialContentClassName, {
        "--focused": isFocused,
    });
    /**
    ...
    return (React__default["default"].createElement($OuterEditorContainer, { className: className },
        React__default["default"].createElement(EditorToolbar, null),
        React__default["default"].createElement($InnerEditorContainer, { ref: editor.containerRef, style: style },
            React__default["default"].createElement(CustomEditable, { className: "wysimark-body", "data-cy": dataCy, readOnly: false, onBlur: onBlur }))));
}
const $OuterEditorContainer = styled__default["default"].div `
  position: relative;
 ...
 * area.
 */
const $InnerEditorContainer = styled__default["default"].div `
  border-radius: ${colors.editorBorderRadius};
...
const Wysimark = function (_a) {
     ...
     */
    const onUpdate = React.useCallback(throttle_1((e) => {
        onUpdateProp(e);
    }, throttle, 
    /**
    ...
    return (React__default["default"].createElement(Reset, null,
        React__default["default"].createElement(ModalProvider, null,
            React__default["default"].createElement(slateReact.Slate, { editor: editor, value: value, onChange: onChange },
                React__default["default"].createElement(Container, Object.assign({}, renderWysimarkProps, { onBlur: onBlur }))))));
};
...
function ensureUnstyledLine(editor, element, path) {
    ...
    for (const [childNode, childPath] of slate.Node.children(editor, path, {
        ...
        if (slate.Text.isText(childNode) && Object.keys(childNode).length === 1)
            continue;
        /**
        ...
        slate.Transforms.insertNodes(editor, { text: slate.Node.string(childNode) }, { at: childPath });
        normalized = true;
    }
    return normalized;
}
...
function isOrphaned(editor, element, path, parentType) {
    ...
    return !slate.Element.isElement(parentNode) || parentNode.type !== parentType;
}
/**
...
function convertOrphanToParagraph(editor, element, path, parentType) {
    ...
    slate.Transforms.setNodes(editor, props, { at: path });
    return true;
}
/**
...
function wrapElementIfEmpty(editor, element, path, defaultElement) {
    if (!isEmptyElement(element))
        return false;
    slate.Transforms.wrapNodes(editor, defaultElement, { at: [...path, 0] });
    return true;
}
...
function removeInvalidChildren(editor, path, validTypes) {
    ...
    for (const [child, childPath] of slate.Node.children(editor, path, {
        ...
        if (!slate.Element.isElement(child) || !validTypes.includes(child.type)) {
            slate.Transforms.removeNodes(editor, { at: childPath });
            normalized = true;
        }
    }
...
function isEmptyElement(element) {
     ...
     */
    if (!slate.Text.isText(onlyChild))
        return false;
    /**
...
function convertChildrenToCodeLine(editor, element, path) {
    ...
    for (const [child, childPath] of children) {
        ...
        slate.Transforms.insertNodes(editor, {
            type: "code-line",
            children: [{ text: slate.Node.string(child) }],
        }, { at: childPath });
        normalized = true;
    }
    return normalized;
...
function normalizeEditor(editorNode) {
    ...
    if (!isConvertibleBlockElement(lastBlock)) {
        slate.Transforms.insertNodes(editorNode, { type: "p", children: [{ text: "" }] }, { at: [editorNode.children.length] });
        return true;
    }
    return false;
}
...
function liftNestedLink(editor, element, path) {
    ...
    for (const [child, childPath] of slate.Node.children(editor, path, {
        ...
        if (slate.Element.isElement(child)) {
            slate.Transforms.liftNodes(editor, { at: childPath });
            normalized = true;
        }
    }
    return normalized;
...
element, path) {
    ...
    for (let i = listStartIndex; i <= listEndIndex; i++) {
         ...
         * `ListItemElement`
         */
        const li = slate.Node.get(editor, [...parentPath, i]);
        /**
        ...
        if (li.type !== "ordered-list-item" || li.number === value)
            continue;
        slate.Transforms.setNodes(editor, { number: value }, { at: [...parentPath, i] });
        normalized = true;
    }
    return normalized;
}
...
function findListStartIndex(editor, parentPath, index) {
    for (let i = index - 1; i >= 0; i--) {
        const node = slate.Node.get(editor, [...parentPath, i]);
...
function findListEndIndex(editor, parentPath, index) {
    const siblingCount = slate.Node.parent(editor, [...parentPath, index]).children
        .length;
...
function reindexTableCell(editor, el, path) {
    ...
    if (el.index == expectedIndex)
        return false;
    slate.Transforms.setNodes(editor, { index: expectedIndex }, { at: path });
    return true;
}
function mergeTableCellSegmentsIntoSingleP(editor, el, path) {
    ...
    slate.Editor.withoutNormalizing(editor, () => {
         ...
         */
        slate.Transforms.insertNodes(editor, { type: "p", children: [] }, { at: insertedParagraphPath });
        /**
        ...
        slate.Transforms.moveNodes(editor, {
            at: path,
            match: (n, p) => {
                return (!slate.Path.isAncestor(insertedParagraphPath, p) &&
                    (slate.Text.isText(n) || isInlineElement(n)));
            },
        ...
        slate.Transforms.removeNodes(editor, {
            at: path,
            match: (n, p) => slate.Path.isParent(path, p) && !slate.Path.equals(p, insertedParagraphPath),
        });
    });
    return true;
}
    ...
    if (tdCount < columnCount) {
        slate.Editor.withoutNormalizing(editor, () => {
            for (let i = tdCount; i < columnCount; i++) {
                slate.Transforms.insertNodes(editor, createTd(i), { at: [...trPath, i] });
            }
        });
        return true;
    }
    ...
    if (tdCount > columnCount) {
        slate.Editor.withoutNormalizing(editor, () => {
            for (let i = tdCount - 1; i >= columnCount; i--) {
                slate.Transforms.removeNodes(editor, { at: [...trPath, i] });
            }
        });
        return true;
    }
...
function withNormalize(editor) {
    ...
    editor.normalizeNode = ([node, path]) => {
        ...
        else if (slate.Editor.isEditor(node)) {
            /**
...
function uploadFile({ file, policy, onProgress, }) {
    return __awaiter(this, void 0, void 0, function* () {
         ...
         */
        const uploadResponse = yield axios__default["default"].post(apiUrl, form, {
            onUploadProgress(e) {
                if (onProgress == null)
                    return;
...
function useStateRef(fn) {
    const [rawState, rawSetState] = React.useState(fn);
    const ref = React.useRef(rawState);
...
function UploadProgressDialog({ dest, editor, files, }) {
     ...
     */
    const setUpload = React.useCallback(function setUpload(file, state) {
        setUploads((prevMap) => {
        ...
        (function () {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                yield Promise.all(Array.from(files).map((file) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    let rawResponse;
                    try {
                        rawResponse = yield axios__default["default"].post(uploadOptions.url, props);
                    }
                    catch (e) {
                        setUpload(file, {
                            status: "error",
...
${e}`,
                ...
                for (const [file, upload] of Array.from(uploadsRef.current.entries())) {
                    if (upload.status === "success") {
                        ...
                        if (upload.width && upload.height) {
                            ...
                            insertLinkBlock(editor, upload.fileUrl, `${file.name} (${prettyBytes__default["default"](file.size)})`);
                        }
                    }
                }
    ...
    return (React__default["default"].createElement(Dialog, { title: hasUploadErrors ? "Errors While Uploading" : "Uploading...", dest: dest, position: Position$1.Inside, width: 320 },
        hasUploadErrors ? (React__default["default"].createElement(React__default["default"].Fragment, null,
            React__default["default"].createElement(Form$1.Block, null,
                React__default["default"].createElement("p", { style: { color: "#cc0000", fontWeight: "bold" } }, "Some files were not uploaded due to these issues."),
                React__default["default"].createElement(Form$1.Button, { className: "btn btn-primary", onClick: modal.close }, "Got It!")),
            React__default["default"].createElement(Form$1.Divider, null))) : null,
        Array.from(uploads.entries()).map(([file, uploadState], index) => {
            if (uploadState.status === "waiting" ||
                ...
                return (React__default["default"].createElement(Form$1.Block, { key: index },
                    React__default["default"].createElement(Form$1.Label, null,
                        "Uploading ",
                        JSON.stringify(file.name)),
                    React__default["default"].createElement(Form$1.Progress, { progress: progress })));
            }
                ...
                return (React__default["default"].createElement(Form$1.Block, { key: index },
                    React__default["default"].createElement(Form$1.Label, null,
                        "Error uploading ",
                        JSON.stringify(file.name)),
                    React__default["default"].createElement($Error, null, uploadState.message)));
            }
            else {
...
const $Error = styled__default["default"].div `
  color: #cc0000;
  font-weight: bold;
  line-height: 24px;
`;
...
function withUpload(editor) {
     ...
     */
    editor.containerRef = React.createRef();
    /**
...
function deleteDynamicAroundNested(editor, direction) {
    const currentLowestBlockEntry = slate.Editor.above(editor, {
        mode: "lowest",
     ...
     */
    const checkBoundary = direction === "forward" ? slate.Editor.isEnd : slate.Editor.isStart;
    if (editor.selection == null) {
     ...
     * user.
     **/
    const getAdjacent = direction === "forward" ? slate.Editor.next : slate.Editor.previous;
    ...
    if (adjacentLowestBlockEntry === undefined)
        return false;
    const sharesParent = isEqual_1(slate.Path.parent(currentLowestBlockEntry[1]), slate.Path.parent(adjacentLowestBlockEntry[1]));
    if (sharesParent)
        return false;
    /**
...
function deleteInCodeLine(editor) {
     ...
     */
    const codeLineEntry = slate.Editor.above(editor, {
        match: (n) => slate.Element.isElement(n) && n.type === "code-line",
    });
    ...
    const codeBlockEntry = slate.Editor.above(editor, {
        match: (n) => slate.Element.isElement(n) && n.type === "code-block",
    });
     ...
     * the `code-block`.
     */
    slate.Transforms.removeNodes(editor, { at: codeBlockEntry[1] });
    return true;
}
...
function deleteInEmptyConvertible(editor, direction) {
     ...
     */
    const currentEntry = slate.Editor.above(editor);
    if (currentEntry === undefined)
        return false;
    const [el, path] = currentEntry;
    if (!isConvertibleBlockElement(el))
        return false;
    const text = slate.Node.string(el);
    if (text.length > 0)
        return false;
    /**
...
function deleteBackwardInList(editor) {
    const liEntry = slate.Editor.above(editor, {
    ...
    const isStart = slate.Editor.isStart(editor, editor.selection.anchor, liPath);
    if (!isStart)
        return false;
    if (liElement.depth === 0)
        return false;
    slate.Transforms.setNodes(editor, { depth: liElement.depth - 1 }, { at: liPath });
    return true;
}
...
function deleteBackwardInTd(editor) {
    var _a;
    const tdNodeEntry = slate.Editor.above(editor, {
        match: (n) => slate.Element.isElement(n) && n.type === "td",
    });
    if (tdNodeEntry == null)
        return false;
    assertDefined((_a = editor.selection) === null || _a === void 0 ? void 0 : _a.anchor, "editor.selection.anchor");
    const isStart = slate.Editor.isStart(editor, editor.selection.anchor, tdNodeEntry[1]);
    return isStart;
}
/**
...
function deleteForwardInTd(editor) {
    ...
    if (tdNodeEntry == null)
        return false;
    assertDefined(editor.selection, "editor.selection");
    const isEnd = slate.Editor.isEnd(editor, editor.selection.anchor, tdNodeEntry[1]);
    return isEnd;
}
...
function insertBreakInListItem(editor, originalInsertBreak) {
     ...
     */
    const listItemEntry = slate.Editor.above(editor, {
        match: isListItemElement,
    });
    /**
    ...
    const s = slate.Node.string(listItemNode);
    /**
    ...
    if (s.length === 0) {
        ...
        if (listItemNode.depth > 0) {
            slate.Transforms.setNodes(editor, { depth: listItemNode.depth - 1 }, { at: listItemPath });
        }
        else if (listItemNode.depth === 0) {
            /**
             * When depth is 0 turn list item into a paragraph
             */
            slate.Transforms.unsetNodes(editor, ["checked", "depth", "number"]);
...
function insertBreakInConvertible(editor, originalInsertBreak, cursor) {
     ...
     */
    const convertibleEntry = slate.Editor.above(editor, {
        match: isConvertibleBlockElement,
    });
    /**
     ...
     */
    const isEnd = slate.Editor.isEnd(editor, cursor, convertiblePath);
    originalInsertBreak();
    /**
...
function insertBreakInCodeLine(editor, originalInsertBreak) {
    ...
    const aboveEntry = slate.Editor.above(editor, {
        match: (n) => {
            return slate.Element.isElement(n) && n.type === "code-line";
        },
    });
    if (!aboveEntry)
        return false;
    const leadingSpaces = countLeadingSpaces(slate.Node.string(aboveEntry[0]));
    originalInsertBreak();
    /**
     * Insert correct number of spaces
     */
    slate.Transforms.insertText(editor, Array(leadingSpaces).fill(" ").join(""));
    return true;
}
    ...
    editor.createActiveImage = (url) => {
        for (const urlPrefix of urlPrefixes) {
            ...
            if (!url.startsWith(urlPrefix))
                continue;
            const urlInfo = resource.getUrlInfo(url);
...
function withEditor(editor) {
    editor = slateReact.withReact(editor);
    editor = slateHistory.withHistory(editor);
...
function useEditor({ initialMarkdown, upload = {
    ...
    if (!editorRef.current ||
        ...
        const editor = withEditor(slate.createEditor());
...
exports.Wysimark = Wysimark;
exports.useEditor = useEditor;
//# sourceMappingURL=index-388dd2b6.js.map
