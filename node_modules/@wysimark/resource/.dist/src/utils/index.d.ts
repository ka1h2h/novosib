import { CloudFrontEvent, CloudFrontRequest, ImageContentType } from "../types";
/**
 * Takes a url, key, path or file name and returns the file extension.
 */
export declare function extractFileExt(uri: string): string;
/**
 * Takes a url, key or path and returns the filename.
 */
export declare function extractFilename(uri: string): string;
/**
 ...
 */
export declare function getImageContentType(uri: string): ImageContentType | undefined;
/**
 ...
 */
export declare function getSortedQueryString(params: URLSearchParams): string;
/**
 ...
 */
export declare function extractKeyFromURI(uri: string): string;
export declare function getSizeFromSearchParams(params: URLSearchParams): {
    width: number;
    height: number;
} | null;
/**
 ...
 * Useful for testing.
 */
export declare function getMockRequestFromURL(urlString: string): CloudFrontRequest;
export declare function getMockEventFromURL(urlString: string): CloudFrontEvent<CloudFrontRequest>;
