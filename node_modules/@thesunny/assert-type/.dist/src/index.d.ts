...
export declare namespace AssertType {
     ...
     */
    type IsEqual<A, B, Y = true, N = false> = (<T>() => T extends A ? 1 : 2) extends (<T>() => T extends B ? 1 : 2) ? Y : N;
    function Equal<A, B>(value: IsEqual<A, B>): void;
    function NotEqual<A, B>(value: IsEqual<A, B> extends true ? false : true): void;
    function Extends<A, B>(value: A extends B ? true : false): void;
    function NotExtends<A, B>(value: A extends B ? false : true): void;
}
